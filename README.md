...
|---        |---         |---           |
| [Meet In The Midl](https://github.com/Timdavidcole/meet-in-the-middle-react-front-end) | Our final project at Makers, this was a fair and equal way of working out where to meet a friend (in London!).  We had two weeks, got it working just about.  We opted for a single page app, like google maps.  Main difficulties were making the stack far too top heavy, putting 3rd party API calls in the front-end, and not having enough time to test for edge cases. | Ruby, Rails, Javascript, React, Cypress, Jest, Rspec |
