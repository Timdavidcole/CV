...
| [Village Green](https://github.com/Timdavidcole/village-green-backend-api) | This is a work in progress, and my first fully personal project from concept, to design, to deployment. I've now finished the rudimentary backend API.  All Node.js & Express and deployed on Heroku (working on AWS). Then I'll start building the front-end soon in React & Redux.  The basic idea is an online parish/community noticeboard based on location, where users can only post to their home address.  | Node.JS, Express, React, Redux, AWS |
