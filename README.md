...
| [Notice](https://github.com/Timdavidcole/village-green-backend-api) | This is a work in progress, but I've finished the rudimentary backend API.  All Node.JS & Express. At the moment it's deployed on Heroku, but I'm currently looking to get on AWS. Then I'll start building the front-end soon in React & Redux.  The basic idea is an online parish/community noticeboard based on location, where users can only post to their home address.  | Node.JS, Express, React, Redux, AWS |
